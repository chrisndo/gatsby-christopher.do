          ...
          <div className="twelve columns">
            ...
            <p>
              <ul>
                ...
                <li>• Led Cyber Risk Assessment of Deloitte’s Cloud Services using a custom developed framework to find anomalies and reported vulnerabilities to senior leadership which initiated remediation efforts to key areas.</li>
